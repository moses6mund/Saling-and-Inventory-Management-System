        ...
        <div class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
          <div class="position-sticky pt-3">
            ...
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{route('sellings.index')}}">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{route('profit.index')}}">
                  <i class="fas fa-truck mr-2"></i> Profit
                </a>
              </li>
              <li class="nav-item">
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Sales Recently</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">Tsh {{ $totalSaleAmountLastDay }}</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-md-3 mb-3">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Sales Recently</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">Tsh {{ $totalSaleAmountLastDay }}</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-md-3 mb-3">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Sale Amount</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">Tsh {{ $totalSaleAmount }}</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-md-3 mb-3">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Sale Amount Today</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">Tsh {{ $totalSaleAmountToday }}</div>
                    </div>
                    <div class="col-auto">
